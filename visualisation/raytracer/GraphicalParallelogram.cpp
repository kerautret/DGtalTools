 ...
 **/
/**
 * @file GraphicalParallelogram.cpp
...
///////////////////////////////////////////////////////////////////////////////
#include <cmath>
#include "GraphicalParallelogram.h"

void
DGtal::rt::GraphicalParallelogram::init( RTViewer& viewer )
{
...
void
DGtal::rt::GraphicalParallelogram::draw( RTViewer& /* viewer */ )
{
...
DGtal::rt::Material
DGtal::rt::GraphicalParallelogram::getMaterial( Point3 p )
{
  Real x, y;
  coordinates( p, x, y );
  return ( ( x < width ) || ( y < width )
           || ( ( 1.0f-x ) < width ) || ( ( 1.0f-y ) < width ) )
